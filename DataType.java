public class DataType{
	public static void main(String[] args){
		...
		system.out.printf("I bought %,d quantity of phones%n",qantity);
		...
		System.out.printf("My account balace is %.2f%n",myBalance);
		
		double cbnBalance = 5647485758475485754.587585;
		Systenout.printf("The CBN balance is %,.2f%n",cbnBalance);
		
		char symbol = '@';
		System.ot.printf("You email address is mercyben405%cgmail.com%n",symbol);
